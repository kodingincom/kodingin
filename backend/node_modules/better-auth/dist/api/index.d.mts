...
import * as better_call81 from "better-call";
...
declare function getEndpoints<Option extends BetterAuthOptions>(ctx: Awaitable<AuthContext>, options: Option): {
  api: {
    readonly ok: better_call81.StrictEndpoint<"/ok", {
      method: "GET";
      metadata: {
        openapi: {
          description: string;
    ...
    readonly error: better_call81.StrictEndpoint<"/error", {
      method: "GET";
      metadata: {
        openapi: {
          description: string;
    ...
    readonly signInSocial: better_call81.StrictEndpoint<"/sign-in/social", {
      method: "POST";
      operationId: string;
    ...
    readonly callbackOAuth: better_call81.StrictEndpoint<"/callback/:id", {
      method: ("GET" | "POST")[];
      operationId: string;
    ...
    readonly getSession: better_call81.StrictEndpoint<"/get-session", {
      method: "GET";
      operationId: string;
      query: zod88.ZodOptional<zod88.ZodObject<{
    ...
    readonly signOut: better_call81.StrictEndpoint<"/sign-out", {
      method: "POST";
      operationId: string;
      requireHeaders: true;
      metadata: {
    ...
    readonly signUpEmail: better_call81.StrictEndpoint<"/sign-up/email", {
      method: "POST";
      operationId: string;
      use: ((inputContext: better_call81.MiddlewareInputContext<better_call81.MiddlewareOptions>) => Promise<void>)[];
    ...
    readonly signInEmail: better_call81.StrictEndpoint<"/sign-in/email", {
      method: "POST";
      operationId: string;
      use: ((inputContext: better_call81.MiddlewareInputContext<better_call81.MiddlewareOptions>) => Promise<void>)[];
      body: zod88.ZodObject<{
    ...
    readonly resetPassword: better_call81.StrictEndpoint<"/reset-password", {
      method: "POST";
      operationId: string;
      query: zod88.ZodOptional<zod88.ZodObject<{
    ...
    readonly verifyPassword: better_call81.StrictEndpoint<"/verify-password", {
      method: "POST";
      body: zod88.ZodObject<{
        password: zod88.ZodString;
      }, zod_v4_core16.$strip>;
      ...
      use: ((inputContext: better_call81.MiddlewareInputContext<better_call81.MiddlewareOptions>) => Promise<{
        session: {
    ...
    readonly verifyEmail: better_call81.StrictEndpoint<"/verify-email", {
      method: "GET";
      operationId: string;
    ...
    readonly sendVerificationEmail: better_call81.StrictEndpoint<"/send-verification-email", {
      method: "POST";
      operationId: string;
      body: zod88.ZodObject<{
        email: zod88.ZodEmail;
    ...
    readonly changeEmail: better_call81.StrictEndpoint<"/change-email", {
      method: "POST";
      body: zod88.ZodObject<{
    ...
    readonly changePassword: better_call81.StrictEndpoint<"/change-password", {
      method: "POST";
      operationId: string;
      body: zod88.ZodObject<{
        newPassword: zod88.ZodString;
    ...
    readonly setPassword: better_call81.StrictEndpoint<string, {
      method: "POST";
      body: zod88.ZodObject<{
        newPassword: zod88.ZodString;
      }, zod_v4_core16.$strip>;
    ...
    readonly updateUser: better_call81.StrictEndpoint<"/update-user", {
      method: "POST";
      operationId: string;
    ...
    readonly deleteUser: better_call81.StrictEndpoint<"/delete-user", {
      method: "POST";
      use: ((inputContext: better_call81.MiddlewareInputContext<better_call81.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly requestPasswordReset: better_call81.StrictEndpoint<"/request-password-reset", {
      method: "POST";
      body: zod88.ZodObject<{
        email: zod88.ZodEmail;
    ...
    readonly requestPasswordResetCallback: better_call81.StrictEndpoint<"/reset-password/:token", {
      method: "GET";
      operationId: string;
      query: zod88.ZodObject<{
    ...
    readonly listSessions: better_call81.StrictEndpoint<"/list-sessions", {
      method: "GET";
      operationId: string;
      use: ((inputContext: better_call81.MiddlewareInputContext<better_call81.MiddlewareOptions>) => Promise<{
        session: {
    ...
    readonly revokeSession: better_call81.StrictEndpoint<"/revoke-session", {
      method: "POST";
      body: zod88.ZodObject<{
        token: zod88.ZodString;
      }, zod_v4_core16.$strip>;
    ...
    readonly revokeSessions: better_call81.StrictEndpoint<"/revoke-sessions", {
      method: "POST";
      use: ((inputContext: better_call81.MiddlewareInputContext<better_call81.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly revokeOtherSessions: better_call81.StrictEndpoint<"/revoke-other-sessions", {
      method: "POST";
      requireHeaders: true;
      use: ((inputContext: better_call81.MiddlewareInputContext<better_call81.MiddlewareOptions>) => Promise<{
        session: {
    ...
    readonly linkSocialAccount: better_call81.StrictEndpoint<"/link-social", {
      method: "POST";
      requireHeaders: true;
      body: zod88.ZodObject<{
        callbackURL: zod88.ZodOptional<zod88.ZodString>;
    ...
    readonly listUserAccounts: better_call81.StrictEndpoint<"/list-accounts", {
      method: "GET";
      use: ((inputContext: better_call81.MiddlewareInputContext<better_call81.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly deleteUserCallback: better_call81.StrictEndpoint<"/delete-user/callback", {
      method: "GET";
      query: zod88.ZodObject<{
        token: zod88.ZodString;
        callbackURL: zod88.ZodOptional<zod88.ZodString>;
    ...
    readonly unlinkAccount: better_call81.StrictEndpoint<"/unlink-account", {
      method: "POST";
      body: zod88.ZodObject<{
    ...
    readonly refreshToken: better_call81.StrictEndpoint<"/refresh-token", {
      method: "POST";
      body: zod88.ZodObject<{
        providerId: zod88.ZodString;
        accountId: zod88.ZodOptional<zod88.ZodString>;
    ...
    readonly getAccessToken: better_call81.StrictEndpoint<"/get-access-token", {
      method: "POST";
      body: zod88.ZodObject<{
        providerId: zod88.ZodString;
        accountId: zod88.ZodOptional<zod88.ZodString>;
    ...
    readonly accountInfo: better_call81.StrictEndpoint<"/account-info", {
      method: "GET";
      use: ((inputContext: better_call81.MiddlewareInputContext<better_call81.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
