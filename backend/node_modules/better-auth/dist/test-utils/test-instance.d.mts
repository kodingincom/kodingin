...
import * as better_call293 from "better-call";
...
declare function getTestInstance<O extends Partial<BetterAuthOptions>, C extends BetterAuthClientOptions>(options?: O | undefined, config?: {
  ...
  client: UnionToIntersection<(C extends undefined ? {} : C) & {
    ...
    readonly ok: better_call293.StrictEndpoint<"/ok", {
      method: "GET";
      metadata: {
        openapi: {
          description: string;
    ...
    readonly error: better_call293.StrictEndpoint<"/error", {
      method: "GET";
      metadata: {
        openapi: {
          description: string;
    ...
    readonly signInSocial: better_call293.StrictEndpoint<"/sign-in/social", {
      method: "POST";
      operationId: string;
    ...
    readonly callbackOAuth: better_call293.StrictEndpoint<"/callback/:id", {
      method: ("GET" | "POST")[];
      operationId: string;
    ...
    readonly getSession: better_call293.StrictEndpoint<"/get-session", {
      method: "GET";
      operationId: string;
      query: zod604.ZodOptional<zod604.ZodObject<{
    ...
    readonly signOut: better_call293.StrictEndpoint<"/sign-out", {
      method: "POST";
      operationId: string;
      requireHeaders: true;
      metadata: {
    ...
    readonly signUpEmail: better_call293.StrictEndpoint<"/sign-up/email", {
      method: "POST";
      operationId: string;
      use: ((inputContext: better_call293.MiddlewareInputContext<better_call293.MiddlewareOptions>) => Promise<void>)[];
    ...
    readonly signInEmail: better_call293.StrictEndpoint<"/sign-in/email", {
      method: "POST";
      operationId: string;
      use: ((inputContext: better_call293.MiddlewareInputContext<better_call293.MiddlewareOptions>) => Promise<void>)[];
      body: zod604.ZodObject<{
    ...
    readonly resetPassword: better_call293.StrictEndpoint<"/reset-password", {
      method: "POST";
      operationId: string;
      query: zod604.ZodOptional<zod604.ZodObject<{
    ...
    readonly verifyPassword: better_call293.StrictEndpoint<"/verify-password", {
      method: "POST";
      body: zod604.ZodObject<{
        password: zod604.ZodString;
      }, zod_v4_core83.$strip>;
      ...
      use: ((inputContext: better_call293.MiddlewareInputContext<better_call293.MiddlewareOptions>) => Promise<{
        session: {
    ...
    readonly verifyEmail: better_call293.StrictEndpoint<"/verify-email", {
      method: "GET";
      operationId: string;
    ...
    readonly sendVerificationEmail: better_call293.StrictEndpoint<"/send-verification-email", {
      method: "POST";
      operationId: string;
      body: zod604.ZodObject<{
        email: zod604.ZodEmail;
    ...
    readonly changeEmail: better_call293.StrictEndpoint<"/change-email", {
      method: "POST";
      body: zod604.ZodObject<{
    ...
    readonly changePassword: better_call293.StrictEndpoint<"/change-password", {
      method: "POST";
      operationId: string;
      body: zod604.ZodObject<{
        newPassword: zod604.ZodString;
    ...
    readonly setPassword: better_call293.StrictEndpoint<string, {
      method: "POST";
      body: zod604.ZodObject<{
        newPassword: zod604.ZodString;
      }, zod_v4_core83.$strip>;
    ...
    readonly updateUser: better_call293.StrictEndpoint<"/update-user", {
      method: "POST";
      operationId: string;
    ...
    readonly deleteUser: better_call293.StrictEndpoint<"/delete-user", {
      method: "POST";
      use: ((inputContext: better_call293.MiddlewareInputContext<better_call293.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly requestPasswordReset: better_call293.StrictEndpoint<"/request-password-reset", {
      method: "POST";
      body: zod604.ZodObject<{
        email: zod604.ZodEmail;
    ...
    readonly requestPasswordResetCallback: better_call293.StrictEndpoint<"/reset-password/:token", {
      method: "GET";
      operationId: string;
      query: zod604.ZodObject<{
    ...
    readonly listSessions: better_call293.StrictEndpoint<"/list-sessions", {
      method: "GET";
      operationId: string;
      use: ((inputContext: better_call293.MiddlewareInputContext<better_call293.MiddlewareOptions>) => Promise<{
        session: {
    ...
    readonly revokeSession: better_call293.StrictEndpoint<"/revoke-session", {
      method: "POST";
      body: zod604.ZodObject<{
        token: zod604.ZodString;
      }, zod_v4_core83.$strip>;
    ...
    readonly revokeSessions: better_call293.StrictEndpoint<"/revoke-sessions", {
      method: "POST";
      use: ((inputContext: better_call293.MiddlewareInputContext<better_call293.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly revokeOtherSessions: better_call293.StrictEndpoint<"/revoke-other-sessions", {
      method: "POST";
      requireHeaders: true;
      use: ((inputContext: better_call293.MiddlewareInputContext<better_call293.MiddlewareOptions>) => Promise<{
        session: {
    ...
    readonly linkSocialAccount: better_call293.StrictEndpoint<"/link-social", {
      method: "POST";
      requireHeaders: true;
      body: zod604.ZodObject<{
        callbackURL: zod604.ZodOptional<zod604.ZodString>;
    ...
    readonly listUserAccounts: better_call293.StrictEndpoint<"/list-accounts", {
      method: "GET";
      use: ((inputContext: better_call293.MiddlewareInputContext<better_call293.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
    ...
    readonly deleteUserCallback: better_call293.StrictEndpoint<"/delete-user/callback", {
      method: "GET";
      query: zod604.ZodObject<{
        token: zod604.ZodString;
        callbackURL: zod604.ZodOptional<zod604.ZodString>;
    ...
    readonly unlinkAccount: better_call293.StrictEndpoint<"/unlink-account", {
      method: "POST";
      body: zod604.ZodObject<{
    ...
    readonly refreshToken: better_call293.StrictEndpoint<"/refresh-token", {
      method: "POST";
      body: zod604.ZodObject<{
        providerId: zod604.ZodString;
        accountId: zod604.ZodOptional<zod604.ZodString>;
    ...
    readonly getAccessToken: better_call293.StrictEndpoint<"/get-access-token", {
      method: "POST";
      body: zod604.ZodObject<{
        providerId: zod604.ZodString;
        accountId: zod604.ZodOptional<zod604.ZodString>;
    ...
    readonly accountInfo: better_call293.StrictEndpoint<"/account-info", {
      method: "GET";
      use: ((inputContext: better_call293.MiddlewareInputContext<better_call293.MiddlewareOptions>) => Promise<{
        session: {
          session: Record<string, any> & {
  ...
  })["plugins"] extends (infer Plugin_1)[] ? UnionToIntersection<Plugin_1 extends _better_auth_core38.BetterAuthClientPlugin ? Plugin_1["getActions"] extends ((...args: any) => infer Actions) ? Actions : {} : {}> : {}) & UnionToIntersection<InferRoute<((C extends undefined ? {} : C) & {
    baseURL: string | undefined;
    fetchOptions: {
      customFetchImpl: (url: string | URL | Request, init?: RequestInit | undefined) => Promise<Response>;
    };
  ...
  db: _better_auth_core_db_adapter1.DBAdapter<BetterAuthOptions>;
