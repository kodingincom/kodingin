...
import * as better_call56 from "better-call";
...
declare const phoneNumber: (options?: PhoneNumberOptions | undefined) => {
  ...
  hooks: {
    before: {
      ...
      handler: (inputContext: better_call56.MiddlewareInputContext<better_call56.MiddlewareOptions>) => Promise<never>;
    }[];
  };
  endpoints: {
    signInPhoneNumber: better_call56.StrictEndpoint<"/sign-in/phone-number", {
      method: "POST";
    ...
    sendPhoneNumberOTP: better_call56.StrictEndpoint<"/phone-number/send-otp", {
      method: "POST";
      body: zod64.ZodObject<{
        phoneNumber: zod64.ZodString;
      }, zod_v4_core11.$strip>;
    ...
    verifyPhoneNumber: better_call56.StrictEndpoint<"/phone-number/verify", {
      method: "POST";
    ...
    requestPasswordResetPhoneNumber: better_call56.StrictEndpoint<"/phone-number/request-password-reset", {
      method: "POST";
      body: zod64.ZodObject<{
        phoneNumber: zod64.ZodString;
      }, zod_v4_core11.$strip>;
    ...
    resetPasswordPhoneNumber: better_call56.StrictEndpoint<"/phone-number/reset-password", {
      method: "POST";
      body: zod64.ZodObject<{
        otp: zod64.ZodString;
        phoneNumber: zod64.ZodString;
