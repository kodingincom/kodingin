...
declare const oAuthProxy: <O extends OAuthProxyOptions>(opts?: O) => {
  ...
  options: NoInfer<O>;
  endpoints: {
    oAuthProxy: better_call245.StrictEndpoint<"/oauth-proxy-callback", {
      method: "GET";
      operationId: string;
      query: z.ZodObject<{
      ...
      use: ((inputContext: better_call245.MiddlewareInputContext<better_call245.MiddlewareOptions>) => Promise<void>)[];
      metadata: {
        openapi: {
          operationId: string;
          description: string;
