...
import * as better_call64 from "better-call";
...
declare const openAPI: <O extends OpenAPIOptions>(options?: O | undefined) => {
  id: "open-api";
  endpoints: {
    generateOpenAPISchema: better_call64.StrictEndpoint<"/open-api/generate-schema", {
      method: "GET";
    }, {
      openapi: string;
      info: {
    ...
    openAPIReference: better_call64.StrictEndpoint<"/reference", {
      method: "GET";
      metadata: {
