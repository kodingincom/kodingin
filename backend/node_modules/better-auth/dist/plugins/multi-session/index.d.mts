...
declare const multiSession: (options?: MultiSessionConfig | undefined) => {
  ...
  endpoints: {
     ...
     */
    listDeviceSessions: better_call1.StrictEndpoint<"/multi-session/list-device-sessions", {
      method: "GET";
      requireHeaders: true;
    }, {
      session: {
     ...
     */
    setActiveSession: better_call1.StrictEndpoint<"/multi-session/set-active", {
      method: "POST";
      body: z.ZodObject<{
     ...
     */
    revokeDeviceSession: better_call1.StrictEndpoint<"/multi-session/revoke", {
      method: "POST";
      body: z.ZodObject<{
        sessionToken: z.ZodString;
      }, z.core.$strip>;
