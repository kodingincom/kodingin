...
declare const anonymous: (options?: AnonymousOptions | undefined) => {
  id: "anonymous";
  endpoints: {
    signInAnonymous: better_call10.StrictEndpoint<"/sign-in/anonymous", {
      method: "POST";
      metadata: {
        openapi: {
          description: string;
    ...
    deleteAnonymousUser: better_call10.StrictEndpoint<"/delete-anonymous-user", {
      method: "POST";
      use: ((inputContext: better_call10.MiddlewareInputContext<better_call10.MiddlewareOptions>) => Promise<{
        session: {
